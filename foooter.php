			...
			<div class="container">
				<div class="row">
					<div class="col-lg-3 col-md-6">
						<h3 data-bs-target="#collapse_1">Hỗ trợ nhanh</h3>
					...
					<div class="col-lg-3 col-md-6">
						...
						<div class="collapse dont-collapse-sm links" id="collapse_2">
							<ul>
								<li><a href="listing-grid-1-full.html">Nội thất phòng khách</a></li>
								<li><a href="listing-grid-2-full.html">Nội thất phòng làm việc</a></li>
								<li><a href="listing-grid-1-full.html">Nội thất phòng ăn</a></li>
								<li><a href="listing-grid-3.html">Nội thất phòng tắm</a></li>
								<li><a href="listing-grid-1-full.html">Nội thất phòng ngủ</a></li>
							</ul>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						...
						<div class="collapse dont-collapse-sm contacts" id="collapse_3">
							<ul>
								<li><i class="ti-home"></i>97845 Baker st. 567<br>Việt Nam - VN</li>
								<li><i class="ti-headphone-alt"></i>+94 423-23-221</li>
								<li><i class="ti-email"></i><a href="#0">info@majestic.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<h3 data-bs-target="#collapse_4">Gửi Email</h3>
